...
INSERT INTO exhibitions (type, club, title, description) VALUES
('전시', '간호보건동아리', '사랑/스트레스 상황의 변화와 관리', '사랑할 때 또는 스트레스 상황에서의 변화 및 관리 방법'),
('전시', 'Be creator', '축제 기획 자료 전시', '축제 기획과 관련된 자료 전시'),
('전시', '플로깅', '플로깅 활동 전시', '''플로깅''의 의미, 다양한 플로깅 활동 및 자료 전시'),
('전시', '사회정책탐구반', '사회정책 연구결과', '사회정책 분석 및 대안 제시 연구결과물 전시'),
('전시', '친환경연구동아리', '친환경 생활용품', '친환경 아이디어로 만든 생활용품 전시'),
('전시', '핸즈온 과학탐구반', '과학 연구결과', '소모임 연구결과 전시'),
('전시/체험', '애니메이션 동아리', '애니메이션 제작 과정', '애니메이션은 어떻게 만들어질까 ? : 제작 과정 전시 및 체험'),
('전시', 'Guide Makers', '박물관 영문 안내서', '내가 만든 박물관 영문 안내서'),
('전시', '뷰티동아리', '맞춤 뷰티 솔루션', '나를 빛내는 맞춤 뷰티 솔루션'),
('전시', 'STEAM사회참여반', '주제 탐구 보고서', '주제 탐구 보고서 전시'),
('전시/체험', 'ARTY 미술반', '사랑 단체작품과 개인작', '단체작품 ''사랑''과 개인작 전시, 페이스페인팅·쥬얼리 메이크업·타투·스페셜 체험 진행'),
('전시', '진로DREAM(드림)', '진로체험 작품', '진로직업체험센터 및 지역사회의 진로 관련 기관들과 연계하여 다양한 진로와 직업활동을 직, 간접적으로 체험하면서 자신의 희망 진로와 관련하여 스스로 디자인한 작품 및 동아리 활동 전시');